...
def server_icon_upload_path(instance, filename):
    return os.path.join('server', instance.id, 'server_icon', filename)


def server_banner_upload_path(instance, filename):
    return os.path.join('server', instance.id, 'server_banner', filename)


def category_icon_upload_path(instance, filename):
    return os.path.join('category', instance.id, 'category_icon', filename)
